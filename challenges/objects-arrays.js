...
console.log(tyrannoDino.weight);

// What was the diet of a velociraptor?
console.log(velociraDino.diet);

// How long was a stegosaurus?
console.log(stegoDino.length);

// What time period did tyrannosaurus live in?
console.log(tyrannoDino.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tyrannoDino.roar = function() {
    return `RAWERSRARARWERSARARARRRR!`;
}
console.log(tyrannoDino.roar());
...
let popLow = zooAnimals.filter(zooAnimal => {
    if (zooAnimal.population <= 5) {
        return true
    };
});
console.log(`population less than 5: ` + popLow);
...
let totalPop = zooAnimals.reduce((population, zooAnimal, index, zooAnimals) => {
